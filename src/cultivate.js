 ...
 *
 * modified by kiki chang:
 * - implemented .garden_store.json
 * - consolidated formal.ejs & natural.ejs into base.ejs
 *
...
async function cultivate(rootPath, relativePath = '.', currDir = '', icvp = null, depth = 3) {
  ...
  // parse .DS_Store
  // if .DS_Store is not found, set to formal layout
  ...
  // filter out gitignore & gardenignored files, then organize into separate arrays for processing
